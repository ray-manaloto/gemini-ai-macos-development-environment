...
allowed-tools:
  ...
  - Bash(mise use -g "npm:@vercel/before-and-after")
...
1. **Pre-flight** — `which before-and-after || mise use -g "npm:@vercel/before-and-after"`
...
| Error | Fix |
|-------|-----|
| `command not found` | `mise use -g "npm:@vercel/before-and-after"` |
