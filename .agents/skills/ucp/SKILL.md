---
name: ucp
description: Expert-level implementation assistant for the Universal Commerce Protocol (UCP), including consultation, planning, scaffolding, validation, and testing workflows for Next.js ecommerce codebases.
arguments:
